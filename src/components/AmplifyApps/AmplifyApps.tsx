          ...
          >
            ...
            <Flex direction="column" alignItems="center" gap="medium">
              ...
              <Text textAlign="center">POST handler for image upload running on Aspire.
                <br/>Use Bun to create thumbnails, encode to base64 and checks.</Text>
            </Flex>
          </Card>
